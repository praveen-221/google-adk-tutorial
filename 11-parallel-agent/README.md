...
The `system_monitor_agent`, uses a Parallel Agent to gather system information concurrently and then synthesizes it into a comprehensive system health report.
...
In this example, a system monitoring application is designed that uses a Parallel Agent to gather system information. The workflow consists of:
...
│       │
│       └── report_synthesizer_agent/     # Report synthesizing agent
│           └── agent.py
│
